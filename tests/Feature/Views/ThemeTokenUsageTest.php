...
class ThemeTokenUsageTest extends TestCase
{
    ...
    public static function themedComponentProvider(): array
    {
        return [
            ...
            'chart-trend-success' => ['components.chart-trend', ['title' => 'Trend', 'labels' => ['Jan'], 'values' => [1], 'color' => 'green'], ['bg-success', 'text-success']],
            'chart-trend-warning' => ['components.chart-trend', ['title' => 'Trend', 'labels' => ['Jan'], 'values' => [1], 'color' => 'yellow'], ['bg-warning', 'text-warning']],
            'chart-trend-danger' => ['components.chart-trend', ['title' => 'Trend', 'labels' => ['Jan'], 'values' => [1]], ['bg-danger', 'text-danger']],
