...
{
    #[Test]
    public function alert_renders_success_variant(): void
    {
    ...
    #[Test]
    public function alert_renders_error_variant(): void
    {
    ...
    #[Test]
    public function alert_danger_alias_renders_error_styling(): void
    {
    ...
    #[Test]
    public function alert_renders_title(): void
    {
    ...
    #[Test]
    public function alert_can_hide_icon(): void
    {
