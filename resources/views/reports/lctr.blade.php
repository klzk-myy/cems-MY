<x-app-layout title="LCTR - Large Cash Transaction Report">
    <div class="p-6">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-2xl font-bold">Large Cash Transaction Report (LCTR)</h1>
        ...
        @if($reportGenerated && count($transactions) > 0)
            <div class="mt-6 flex items-center justify-between">
                ...
                <div class="flex gap-3">
                    <button type="button" onclick="window.print()" class="px-4 py-2 text-sm font-medium rounded-lg bg-white border border-[#e5e5e5] text-gray-700 hover:bg-gray-50">
                        Print Report
                    </button>
                    <button type="button" class="px-4 py-2 text-sm font-medium rounded-lg bg-[#0a0a0a] text-white hover:bg-[#262626]">
                        Export PDF
                    </button>
                </div>
            </div>
