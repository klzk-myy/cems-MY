    ...
    <div class="p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div class="bg-white border border-[#e5e5e5] rounded-xl p-6">
                <div class="text-xs font-medium text-gray-500 uppercase mb-2">Total Realized P&L</div>
            ...
            <div class="bg-white border border-[#e5e5e5] rounded-xl p-6">
                <div class="text-xs font-medium text-gray-500 uppercase mb-2">Total Unrealized P&L</div>
            ...
            <div class="bg-white border border-[#e5e5e5] rounded-xl p-6">
                <div class="text-xs font-medium text-gray-500 uppercase mb-2">Total P&L</div>
        ...
        <div class="bg-white border border-[#e5e5e5] rounded-xl p-6 mb-6">
            <form method="GET" action="{{ route('reports.profitability') }}" class="flex flex-wrap gap-4 items-end">
                <div>
                    <label for="start_date" class="text-xs font-medium text-gray-500 uppercase">Start Date</label>
                ...
                <div>
                    <label for="end_date" class="text-xs font-medium text-gray-500 uppercase">End Date</label>
            ...
            <table class="w-full">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase">Position</th>
                        <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase">Avg Buy Rate</th>
                        <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase">Avg Sell Rate</th>
                        <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase">Realized P&L</th>
                        <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase">Unrealized P&L</th>
                        <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase">Total P&L</th>
                    </tr>
                </thead>
