<x-email-layout title="{{ ucfirst(str_replace('-', ' ', system-health)) }} Notification">
    <p>This is an automated notification from CEMS regarding {{ str_replace('-', ' ', system-health) }}.</p>
