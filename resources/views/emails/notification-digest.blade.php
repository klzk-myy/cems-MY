<x-email-layout title="{{ ucfirst(str_replace('-', ' ', notification-digest)) }} Notification">
    <p>This is an automated notification from CEMS regarding {{ str_replace('-', ' ', notification-digest) }}.</p>
