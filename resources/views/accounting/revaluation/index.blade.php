    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">Revalue currency positions based on exchange rates</p>
            </div>
        ...
        <div class="bg-white border border-[#e5e5e5] rounded-xl p-6">
            <h3 class="text-sm font-medium text-gray-900 mb-4">Current Exchange Rates</h3>
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div class="p-4 border border-[#e5e5e5] rounded-lg">
                    <p class="text-sm text-gray-500">USD/MYR</p>
                    <p class="mt-1 text-xl font-semibold text-gray-900">4.7200</p>
                    <p class="text-xs text-green-600">+0.0200 from base</p>
                </div>
                <div class="p-4 border border-[#e5e5e5] rounded-lg">
                    <p class="text-sm text-gray-500">SGD/MYR</p>
                    <p class="mt-1 text-xl font-semibold text-gray-900">3.5100</p>
                    <p class="text-xs text-green-600">+0.0150 from base</p>
                </div>
                <div class="p-4 border border-[#e5e5e5] rounded-lg">
                    <p class="text-sm text-gray-500">GBP/MYR</p>
                    <p class="mt-1 text-xl font-semibold text-gray-900">5.9500</p>
                    <p class="text-xs text-red-600">-0.0100 from base</p>
                </div>
                <div class="p-4 border border-[#e5e5e5] rounded-lg">
                    <p class="text-sm text-gray-500">EUR/MYR</p>
                    <p class="mt-1 text-xl font-semibold text-gray-900">5.1800</p>
        ...
        <div class="bg-white border border-[#e5e5e5] rounded-xl overflow-hidden">
            <div class="px-4 py-3 border-b border-[#e5e5e5]">
                <h3 class="text-sm font-medium text-gray-900">Revaluation Preview - May 2026</h3>
            </div>
            <table class="w-full">
                <thead class="bg-gray-50 border-b border-[#e5e5e5]">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">Current Rate</th>
                        <th class="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">Base Value (MYR)</th>
                        <th class="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">Current Value (MYR)</th>
                ...
                <tfoot class="bg-gray-50 border-t border-[#e5e5e5]">
                    <tr>
                        <td colspan="5" class="px-4 py-3 text-sm font-medium text-gray-900">Total</td>
        ...
        <div class="bg-white border border-[#e5e5e5] rounded-xl p-6">
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-sm font-medium text-gray-900">Last Revaluation</h3>
                    <p class="mt-1 text-sm text-gray-500">April 30, 2026</p>
                </div>
