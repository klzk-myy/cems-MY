<x-app-layout title="Acknowledge Handover">
    <div class="p-6">
        <div class="mb-6">
            ...
            <p class="text-gray-500 text-sm mt-1">Confirm receipt of counter custody from previous operator</p>
        </div>
        ...
        <div class="bg-white border border-[#e5e5e5] rounded-xl p-6 max-w-lg">
            ...
            <div class="mb-6">
                ...
                <p class="text-sm text-gray-600 bg-gray-50 rounded-lg p-3">{{ $notes }}</p>
            </div>
            @endisset
