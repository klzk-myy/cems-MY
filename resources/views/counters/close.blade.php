                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" value="{{ $rates[$currency] ?? '0.00' }}" class="w-full px-4 py-2.5 text-sm bg-canvas-subtle border border-[#e5e5e5] rounded-lg" readonly>
                            </div>
                            <div>
                                <span class="text-xs text-ink-muted">MYR Value</span>
                                <input type="text" class="w-full px-4 py-2.5 text-sm bg-canvas-subtle border border-[#e5e5e5] rounded-lg" readonly>
                            </div>
                        </div>
                    </div>
                    @endforeach
