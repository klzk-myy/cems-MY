...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white border border-[#e5e5e5] rounded-xl p-6 mb-6">
            <h2 class="text-lg font-medium text-gray-900 mb-4">Position Details</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div>
                    <dt class="text-sm font-medium text-gray-500">Reserved Amount</dt>
                    <dd class="mt-1 text-sm text-gray-900">
        ...
        <div class="bg-white border border-[#e5e5e5] rounded-xl p-6">
            <h2 class="text-lg font-medium text-gray-900 mb-4">Recent Buy Transactions (Last 50)</h2>
