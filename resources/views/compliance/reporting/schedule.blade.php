                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        <div class="w-12 h-12 flex items-center justify-center bg-purple-100 rounded-lg">
                            <span class="text-lg font-bold text-purple-700">LCTR</span>
                        </div>
                        <div>
                            <p class="text-sm font-medium text-gray-900">LCTR Report Generation</p>
                            <p class="text-xs text-gray-500">28th of every month at 00:00</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-3">
                        <span class="inline-flex px-2.5 py-0.5 text-xs font-medium rounded bg-green-100 text-green-700">Active</span>
