...
<head>
    ...
    <title>Batch Upload - Transactions</title>
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <div class="bg-white border-b border-[#e5e5e5]">
            <div class="max-w-7xl mx-auto px-6 py-6">
                <h1 class="text-2xl font-semibold text-gray-900">Batch Upload</h1>
                <p class="mt-1 text-sm text-gray-500">Upload multiple transactions in bulk</p>
            </div>
        </div>
