...
<head>
    ...
    <title>Customer History - Transactions</title>
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <div class="bg-white border-b border-[#e5e5e5]">
            <div class="max-w-7xl mx-auto px-6 py-6">
                <h1 class="text-2xl font-semibold text-gray-900">Customer Transaction History</h1>
                <p class="mt-1 text-sm text-gray-500">View transaction history for this customer</p>
            </div>
        </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-900">{{ $customer['id_number'] ?? 'N/A' }}</p>
                        </div>
                        <div>
