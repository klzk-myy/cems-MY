...
<head>
    ...
    <title>Reject Cancellation - Transactions</title>
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <div class="bg-white border-b border-[#e5e5e5]">
            <div class="max-w-7xl mx-auto px-6 py-6">
                <h1 class="text-2xl font-semibold text-gray-900">Reject Cancellation</h1>
                <p class="mt-1 text-sm text-gray-500">Reject transaction cancellation request</p>
            </div>
        </div>
        ...
        <main class="flex-1 max-w-7xl mx-auto px-6 py-6 w-full">
            ...
            <div class="bg-white border border-[#e5e5e5] rounded-xl mb-6">
                ...
                <div class="p-6">
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-500 mb-1">Reason Provided</label>
            ...
            <div class="bg-white border border-[#e5e5e5] rounded-xl mb-6">
                <div class="px-6 py-4 border-b border-[#e5e5e5]">
                    <h2 class="text-lg font-medium text-gray-900">Rejection Details</h2>
                </div>
                <div class="p-6">
            ...
            <div class="bg-white border border-[#e5e5e5] rounded-xl">
                <div class="px-6 py-4 border-b border-[#e5e5e5]">
                    <h2 class="text-lg font-medium text-gray-900">Notice</h2>
                </div>
                <div class="p-6">
