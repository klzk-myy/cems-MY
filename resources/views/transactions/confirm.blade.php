<x-app-layout title="Confirm Transaction">
    <div class="p-6">
        <div class="mb-6">
            ...
            <p class="text-sm text-gray-500 mt-1">Review and confirm transaction details</p>
        </div>
            ...
            <div class="p-6">
                <form method="POST" action="{{ route('transactions.confirm.store', $transaction['id'] ?? 0) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="mfa_code" name="mfa_code" required maxlength="6" pattern="[0-9]{6}" class="w-full px-4 py-2.5 text-sm bg-white border border-[#e5e5e5] rounded-lg" placeholder="Enter 6-digit MFA code">
                        @error('mfa_code')
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <a href="{{ route('transactions.create') }}" class="px-4 py-2 text-sm font-medium rounded-lg bg-white border border-[#e5e5e5] hover:bg-gray-50">
                            Back
                        </a>
                    </div>
                </form>
