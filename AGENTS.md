...
This project is indexed by GitNexus as **cems-my** (6881 symbols, 19339 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
