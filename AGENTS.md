...
This project is indexed by GitNexus as **cems-my** (9981 symbols, 25412 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
