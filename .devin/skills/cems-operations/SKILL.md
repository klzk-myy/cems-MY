...
- **New customers get risk_score 60 / High by default** — risk assessed at creation; a High-risk customer's transaction goes to `Pending` (compliance hold), not `Confirmed`.
