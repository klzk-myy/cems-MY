...
class StockTransferFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'source_branch_name' => fn (array $attributes) => Branch::query()->whereKey($attributes['source_branch_id'])->value('name'),
            'destination_branch_id' => Branch::factory(),
            'destination_branch_name' => fn (array $attributes) => Branch::query()->whereKey($attributes['destination_branch_id'])->value('name'),
