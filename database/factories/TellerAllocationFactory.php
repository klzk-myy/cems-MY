...
class TellerAllocationFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'currency_code' => 'USD',
            'allocated_quantity' => $this->faker->randomFloat(4, 10000, 100000),
            'current_quantity' => $this->faker->randomFloat(4, 10000, 100000),
            'requested_quantity' => $this->faker->randomFloat(4, 10000, 100000),
